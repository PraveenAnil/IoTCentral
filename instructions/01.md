...
1. From the left navigation pane select **Devices** this displays the list of all devices connect to your application.
...
1. From the left navigate menu, navigate to the **Administration** section in your application.

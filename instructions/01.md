...
The default dashboard is a connected logistics operator focused portal for Northwind Trader which is a fictitious logistics provider managing a cargo fleet at sea and on land.

In this task you will explore through some of the key features like **Dashboard**, **Device Templates**, **Rules** that are available by deafult in your application.

#### Explore and cutsomize Dashboard
...
1. On the dashboard page in **Location tile** select the expand icon. This will provide a full screen view of the Location tile. 

   ![](media/img127.png) 

1. In the **Location** tile you can see all the routes that was taken in past 30 minutes. Click on pinned icon in the location tile page, this will provide details on longitude, latitude and time. Select **Back to dashboard view**. 

1. Now on the dashboard page in **Logistics location** tile select the expand icon. From here you can see the current location of the device. 

1. Now select **Back to dashboard view** to return to the dashboard.
...
In this section you will explore through the various options available in Logistic gateway device template.
...
In this section you will configure a telemetry rule that will 
Telemetry is the data values transmitted by sensors.
...
In this exercise, you have learnt how to create application from IoT Central, add exlpored through your application dashboard. You also learnt to add new device's in the application, created rules, configured jobs and analyzed telemetry data.

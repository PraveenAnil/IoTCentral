...
1. In the **Location** tile you can see all the routes that was taken in past 30 minutes. Click on pinned icon in the location tile page, this will provide details on longitude, latitude and time.

1. Select **Back to dashboard view**. 

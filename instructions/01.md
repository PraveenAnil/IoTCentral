...
1. In the **Location** tile you can see all the routes that was taken in past 30 minutes. Now click on pinned icon in the location tile page, this will provide details on longitude, latitude and time. 

   ![](media/img128.png) 

1. Now select **Back to dashboard view** return to the dashboard.
...
1. On the edit dashboard page in the left navigation menu under **Dashboard settings**, enter a friendly name for your dashboard under **Dashboard name**. Under **Type** select **Application (Viewable to all users)**.

...
1. Switch back to the **Device Templates** page, from here you can add new device templates by clicking on **+ New** icon. For now proceed to next task we will see how to create **Device Templates** in the coming exercise.

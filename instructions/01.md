...
In this task you will create a connected logistics application using built-in template from Azure IoT central.
...
In this task you will explore through some of the key features like **Dashboard**, **Device Templates**, **Rules** that are available in your application.

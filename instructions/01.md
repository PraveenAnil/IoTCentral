...
1. In the **Location** tile you can see all the routes that was taken in past 30 minutes. Now click on pinned icon in the location tile page, this will provide details on longitude, latitude and time. Select **Back to dashboard view**. 
...
1. From the dashboard you can do device management operations such as: update firmware, disable and enable sensors, update a sensor threshold, update telemetry intervals, and update device service contracts.

...
1. **Create app** opens a **New application form**. Enter the following details:
     ...
     - **Application name**: Use the default suggested name.
     
     - **URL**: Use the suggested default URL or enter your friendly unique memorable URL.
...
1. On the edit dashboard page in the left navigation menu under **Dashboard settings**, enter a friendly name for your dashboard in **Dashboard name**. Optionally you can also select the type of visibility you want.

...
In this exercise, you have learnt how to create application from IoT Central, add exlpored through your application dashboard. You also learnt to add new device's in the application, created rules, configured jobs and analysed telemetry data.

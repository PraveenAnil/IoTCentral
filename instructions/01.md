...
In this task you will create a connected logistics application form Azure IoT cental.
...
In this task you will exlpore through features that are available in the connected logistics application.
...
1. Explore through the kinds of tiles  displayed in the dashboard like **Location**, **Gateway state**, **Battery utilization**, **Multimodal transport** and much more.
...
In this section you will explore through 

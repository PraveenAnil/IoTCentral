...
### Task 2: Integrate IoT Central Application with other cloud services or existing enterprise and line of business solutions 
  ...
  In this task, you will configure a Logic App to be triggered by a . The data will be sent to the Service Bus queue from Stream Analytics if the average temperature of the devices exceeds a certain value.
...
1. In the **Execute a device command(preview)** page, select the following:
 ...
 In this task, you will configure your IoT Central application to export telemetry collected from the devices, to the storage account.

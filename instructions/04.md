...
### Task 2: Integrate IoT Central Application with other cloud services or existing enterprise and line of business solutions 
  ...
  In this task, Detect an anomaly by Adding a rule to detect increased temperature over a time window of 5 mins in IoT Central App which will trigger a workflow in Azure Logic App to disable the sensor and enable it again on the device 
